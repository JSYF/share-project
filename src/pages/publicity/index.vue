<template>
  <div class="publicity-page">
    ...
    <div class="bg-wrap">
      <img class="bg-1" src="http://image.haoxuezhuli.com/saas-dir/publicity_01.png">
    </div>
    <div class="input-wrap">
      <p class="input-tips">——提交信息，领取完整运营方案，免费试用——</p>
    ...
    <div class="bg-wrap">
      <img class="bg-3" src="http://image.haoxuezhuli.com/saas-dir/publicity_03.png">
    </div>
    <div class="bg-wrap">
      <img class="bg-4" src="http://image.haoxuezhuli.com/saas-dir/publicity_04.png">
    </div>
    <div class="bg-wrap">
      <img class="bg-5" src="http://image.haoxuezhuli.com/saas-dir/publicity_05.png">
    </div>
...
export default {
  ...
  mounted() {
    let obj = {
      ...
      imgUrl: require("../../assets/img/yunhan/yunhan-logo.png"),
